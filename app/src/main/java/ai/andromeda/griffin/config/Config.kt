...
object Config {
    ...
    const val LOCAL_BROKER_IP = "tcp://192.168.0.104:1883" // TODO
    const val SUBSCRIPTION_TOPIC = "Pub/Griffin0"
    const val PUBLISH_TOPIC = "Sub/Griffin0"
    const val GLOBAL_BROKER_IP = "tcp://192.168.0.104:1883" // TODO
    const val ALLOWED_CHARACTERS = "0123456789qwertyuiopasdfghjklzxcvbnm"
    const val ID_LENGTH = 8
    const val SENSOR_STATUS_LOCKED = 0
    const val SENSOR_STATUS_OPEN = 1
